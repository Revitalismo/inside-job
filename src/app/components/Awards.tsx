...
export function Awards({ totalCooporatedClient, totalExtendedContract, totalDeployedWeb}: AwardsProps) {
    return (
        <section className="w-fill md:w-fit gap-y-6 gap-x-4 flex flex-wrap justify-center p-4 md:border-[1px] md:border-primary-400 md:bg-[rgba(14,101,139,0.50)] rounded-[10px] backdrop-blur md:absolute xl:left-[-70px] bottom-[-20px]">
            ...
            <article className="w-[90px] sm:w-[120px] flex flex-col gap-y-1 items-center">
                ...
                <h4 className="text-sm sm:text-base text-neutral-0 text-center">Client telah bekerja sama</h4>
            </article>
            ...
            <article className="w-[150px] flex flex-col gap-y-1 items-center">
                ...
                <h4 className="text-sm sm:text-base text-neutral-0 text-center">Client minta perpanjang kontrak</h4>
            </article>
            ...
            <article className="w-[100px] sm:w-[120px] flex flex-col gap-y-1 items-center">
                ...
                <h4 className="text-sm sm:text-base text-neutral-0 text-center">Web telah kami deploy</h4>
            </article>
        </section>
    );
}