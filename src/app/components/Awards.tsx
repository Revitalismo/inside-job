...
export function Awards({ totalCooporatedClient, totalExtendedContract, totalDeployedWeb}: AwardsProps) {
    return (
        <section className="w-full gap-y-6 gap-x-4 flex flex-wrap justify-center md:p-4 md:border-[1px] md:border-primary-400 md:bg-[rgba(14,101,139,0.50)] rounded-[10px] backdrop-blur">
