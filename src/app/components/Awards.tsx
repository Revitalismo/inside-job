...
export function Awards({ totalCooporatedClient, totalExtendedContract, totalDeployedWeb}: AwardsProps) {
    return (
        <section className="w-fill md:w-fit gap-y-6 gap-x-4 flex flex-wrap justify-center p-4 md:border-[1px] md:border-primary-400 md:bg-[rgba(14,101,139,0.50)] rounded-[10px] backdrop-blur absolute left-[-70px] bottom-[-20px]">
