...
export function Collaboration({ clientName }: { clientName: client }) {
    ...
    return (
        <section className="w-fit mx-auto py-2.5 px-4 bg-[rgba(10,67,92,0.50)] absolute top-0 left-0 right-0 flex gap-x-4 items-center backdrop-blur-sm border-primary-500 border-[1.5px] rounded-lg">
            <Image
                src={logoInsideJob}
                alt="Logo Inside Job"
