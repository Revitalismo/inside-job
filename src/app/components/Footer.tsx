...
function Services() {
    ...
    return (
        <article className="w-fit min-w-[150px] max-w-[600px] row-start-2 row-end-2 col-span-1 justify-self-start flex flex-col gap-y-3 sm:col-start-3 sm:col-end-3 sm:row-start-1 sm:row-end-1 sm:justify-self-end text-primary-0">
            ...
            <section className="flex flex-col gap-y-2.5">
                {
                    serviceMap.map((menu) => {
                        return (
                            <Link href={menu.name[0]} className="hover:text-primary-200" key={menu.name[0]}>
                                {menu.name[1]}
                            </Link>
                        );
                    })
