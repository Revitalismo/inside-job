...
export function RecentWorkCard({ title, image, description, navigateTo }: RecentWorkCardProps) {
    return (
        <article className={`w-full sm:min-w-[600px] max-w-[328px] sm:max-w-[600px] min-h-[320px] sm:min-h-[450px] relative border-primary-500 border-[1.5px] rounded-2xl bg-primary-100`}
            style={{ "backgroundImage": `url(./recent-works/${image}.webp)` }}
        >
